    ...
    def decorator(func: Callable) -> Callable:
        ...
        if multi_sig:
            if not required_signatures or not threshold:
                raise ValueError("Multi-signature tools require required_signatures and threshold")
            ...
            class MultiSigFunctionTool(MultiSignatureTool):
                def __init__(self):
                    ...
                    self.func = func
                    self.description = description or f"Multi-signature trusted tool: {tool_id}"
